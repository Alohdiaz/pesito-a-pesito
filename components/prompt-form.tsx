...
export function PromptForm({
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // No enviar si la entrada está deshabilitada o vacía
    ...
    try {
      ...
      // Agregar mensaje de usuario a la interfaz de usuario inmediatamente
      const userMessage = {
        id: nanoid(),
      ...
      // Obtenga respuesta de IA
      const responseMessage = await submitUserMessage(value)

      // Añadir respuesta de IA a la interfaz de usuario
      ...
      // Entrada de enfoque después de la finalización
      if (inputRef.current) {
        inputRef.current.focus()
      }
    }
